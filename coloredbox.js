(function () {
  ...
  class ColoredBox extends HTMLElement {
    //自定义微件的JavaScript API
    constructor() {
      //构造器，仅会触发一次，当微件被添加到App Designer/Story 2.0时触发
      super(); //必须调用
      console.log("coloredbox.js - constructor");
